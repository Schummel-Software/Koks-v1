            ...
            if (module.isVisible()) {
                if (Koks.getKoks().moduleManager.getModule(ClearTag.class).isToggled()) {
                    ...
                    if(shadow) {
                        ...
                        renderUtils.drawImage(new ResourceLocation("client/shadows/arraylistshadow.png"), sr.getScaledWidth() - fr.getStringWidth(module.getModuleName()) - 4, y[0], fr.getStringWidth(module.getModuleName()), 15, false);
